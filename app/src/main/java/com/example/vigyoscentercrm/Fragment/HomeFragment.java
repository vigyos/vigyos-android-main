...
public class HomeFragment extends Fragment implements View.OnClickListener {
    ...
    private CardView walletCardView, supportCardView;
    private CardView offerCardView, seeMore;
    ...
    private void initialization(){
        ...
        supportCardView = view.findViewById(R.id.supportCardView);
        offerCardView = view.findViewById(R.id.offerCardView);
    ...
    private void declaration(){
        ...
        supportCardView.setOnClickListener(this);
        offerCardView.setOnClickListener(this);
    ...
    public void onClick(View v) {
        switch (v.getId()){
            case R.id.userAccount:
                ...
                break;
            case R.id.walletCardView:
                replaceFragment(new WalletFragment());
                break;
            case R.id.supportCardView:
                Log.i("2026" , "supportCardView");
                break;
            case R.id.offerCardView:
                Log.i("2026" , "offerCardView");
                break;
