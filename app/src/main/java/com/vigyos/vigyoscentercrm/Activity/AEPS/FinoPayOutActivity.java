...
public class FinoPayOutActivity extends AppCompatActivity {
    ...
    private void declaration() {
        animation = AnimationUtils.loadAnimation(FinoPayOutActivity.this, R.anim.shake_animation);
        fusedLocationClient = LocationServices.getFusedLocationProviderClient(FinoPayOutActivity.this);
        ...
        addBank.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                v.startAnimation(AnimationUtils.loadAnimation(FinoPayOutActivity.this, R.anim.viewpush));
                startActivity(new Intent(FinoPayOutActivity.this, FinoPayoutAddAccountActivity.class));
            }
        });
        payoutList();
        ...
        createPayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (payoutBankName.getSelectedItem().toString().trim().equals("Select your bank")) {
                    ...
                    Toast.makeText(FinoPayOutActivity.this,"Select your bank",Toast.LENGTH_SHORT).show();
                    return;
                }
                if(TextUtils.isEmpty(payoutAmount.getText().toString())){
                    ...
                    Toast.makeText(FinoPayOutActivity.this, "Enter a Amount", Toast.LENGTH_SHORT).show();
                    return;
                } else {
                    if (!isNumeric(payoutAmount.getText().toString())){
                        ...
                        payoutAmountLyt.startAnimation(animation);
                        payoutAmountFocus.getParent().requestChildFocus(payoutAmountFocus, payoutAmountFocus);
                        Toast.makeText(FinoPayOutActivity.this, "Enter a valid Amount", Toast.LENGTH_SHORT).show();
                        return;
                    }
                }
    ...
    private void areYouSure(){
        dialog = new Dialog(FinoPayOutActivity.this);
    ...
    private void createPayoutAPI() {
        pleaseWait();
        Call<Object> objectCall = RetrofitClient.getApi().finoCreatePayOutAPI(SplashActivity.prefManager.getToken(), beneId, payoutAmount.getText().toString(), "IMPS", SplashActivity.prefManager.getFinoMerchantId(),
        ...
        objectCall.enqueue(new Callback<Object>() {
            ...
            public void onFailure(@NonNull Call<Object> call, @NonNull Throwable t) {
                ...
                Toast.makeText(FinoPayOutActivity.this, "Payout Failed", Toast.LENGTH_SHORT).show();
            }
        });
    }
        ...
        objectCall.enqueue(new Callback<Object>() {
            ...
            public void onResponse(@NonNull Call<Object> call, @NonNull Response<Object> response) {
                ...
                try {
                    ...
                    ArrayAdapter<String> spinnerArrayAdapter = new ArrayAdapter<>(FinoPayOutActivity.this, R.layout.layout_spinner_item, bankNameArray); //selected item will look like a spinner set from XML
                            ...
                            if (parent.getItemAtPosition(position).equals("Select your bank")) {
                                ...
                                for (PayoutBankNameModel bankNameModel: bankNameModels){
                                    if(bankNameModel.getBankname().equalsIgnoreCase(selectedItem)){
                                        ...
                                        if (bankName.isEmpty()) {
                                            Toast.makeText(FinoPayOutActivity.this, "Add Bank Account", Toast.LENGTH_SHORT).show();
                                        }
    ...
    private boolean checkPermission() {
        int result = ContextCompat.checkSelfPermission(FinoPayOutActivity.this, ACCESS_FINE_LOCATION);
        return result == PackageManager.PERMISSION_GRANTED;
    }

    public void requestPermissions() {
        Dexter.withContext(FinoPayOutActivity.this)
    ...
    private void getLocation() {
        if (ContextCompat.checkSelfPermission(FinoPayOutActivity.this, Manifest.permission.ACCESS_FINE_LOCATION) == PackageManager.PERMISSION_GRANTED) {
            fusedLocationClient.getLastLocation()
                    .addOnSuccessListener(FinoPayOutActivity.this, new OnSuccessListener<Location>() {
                        @Override
                    ...
                    .addOnFailureListener(FinoPayOutActivity.this, new OnFailureListener() {
                        @Override
