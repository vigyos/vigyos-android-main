...
public class FinoPayoutAddAccountActivity extends AppCompatActivity {
    ...
    private void declaration() {
        animation = AnimationUtils.loadAnimation(FinoPayoutAddAccountActivity.this, R.anim.shake_animation);
        payoutBanks();
        ...
        passbookImageLyt.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (ContextCompat.checkSelfPermission(FinoPayoutAddAccountActivity.this, Manifest.permission.CAMERA) == PackageManager.PERMISSION_GRANTED
                && ContextCompat.checkSelfPermission(FinoPayoutAddAccountActivity.this, Manifest.permission.READ_EXTERNAL_STORAGE) == PackageManager.PERMISSION_GRANTED
                        || ContextCompat.checkSelfPermission(FinoPayoutAddAccountActivity.this, Manifest.permission.READ_MEDIA_IMAGES) == PackageManager.PERMISSION_GRANTED) {

                    ImagePicker.with(FinoPayoutAddAccountActivity.this)
                            .crop()
                            .compress(1024)
        ...
        addAccountButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (bankNameSpinner.getSelectedItem().toString().trim().equals("Select your bank")) {
                    ...
                    StyleableToast.makeText(FinoPayoutAddAccountActivity.this, "Select your bank", Toast.LENGTH_LONG, R.style.myToastWarning).show();
                    return;
                }
                if(TextUtils.isEmpty(accountNumber.getText().toString())){
                    ...
                    StyleableToast.makeText(FinoPayoutAddAccountActivity.this, "Enter Account Number", Toast.LENGTH_LONG, R.style.myToastWarning).show();
                    return;
                }
                if(TextUtils.isEmpty(ifscNumber.getText().toString())){
                    ...
                    StyleableToast.makeText(FinoPayoutAddAccountActivity.this, "Enter IFSC Code", Toast.LENGTH_LONG, R.style.myToastWarning).show();
                    return;
                }
                if(TextUtils.isEmpty(accountHolderName.getText().toString())){
                    ...
                    StyleableToast.makeText(FinoPayoutAddAccountActivity.this, "Enter Account Holder Name", Toast.LENGTH_LONG, R.style.myToastWarning).show();
                    return;
                }
                if (accountType.getSelectedItem().toString().trim().equals("Select Account Type")) {
                    ...
                    StyleableToast.makeText(FinoPayoutAddAccountActivity.this, "Select Account Type", Toast.LENGTH_LONG, R.style.myToastWarning).show();
                    return;
                }
                if (!passbook) {
                    ...
                    StyleableToast.makeText(FinoPayoutAddAccountActivity.this, "Select PassBook Image", Toast.LENGTH_LONG, R.style.myToastWarning).show();
                    return;
                }
                if (selectDocumentType.getSelectedItem().toString().trim().equals("Select Document Type")) {
                    ...
                    StyleableToast.makeText(FinoPayoutAddAccountActivity.this, "Select Document Type", Toast.LENGTH_LONG, R.style.myToastWarning).show();
                    return;
                }
                if (documentTypeName.equalsIgnoreCase("PAN")) {
                    if (!panCard){
                        ...
                        StyleableToast.makeText(FinoPayoutAddAccountActivity.this, "Select Pan Card Image", Toast.LENGTH_LONG, R.style.myToastWarning).show();
                        return;
                    }
                } else {
                    if (!aadhaarFront){
                        ...
                        StyleableToast.makeText(FinoPayoutAddAccountActivity.this, "Select Aadhaar Front Image", Toast.LENGTH_LONG, R.style.myToastWarning).show();
                        return;
                    } else if (!aadhaarBack) {
                        aadhaarBackLyt.startAnimation(animation);
                        aadhaarBackFocus.getParent().requestChildFocus(aadhaarBackFocus, aadhaarBackFocus);
                        StyleableToast.makeText(FinoPayoutAddAccountActivity.this, "Select Aadhaar Back Image", Toast.LENGTH_LONG, R.style.myToastWarning).show();
                        return;
                    }
                }
                ...
                try {
                    ...
                    if (jsonObject.has("status") && jsonObject.getBoolean("status")) {
                        ...
                        if (jsonObject.has("message")) {
                            StyleableToast.makeText(FinoPayoutAddAccountActivity.this, jsonObject.getString("message"), Toast.LENGTH_LONG, R.style.myToastWarning).show();
                        }
                    }
            ...
            objectCall.enqueue(new Callback<Object>() {
                ...
                public void onResponse(@NonNull Call<Object> call, @NonNull Response<Object> response) {
                    ...
                    try {
                        ...
                        if (jsonObject.has("status") && jsonObject.getBoolean("status")) {
                            if (jsonObject.has("message")) {
                                StyleableToast.makeText(FinoPayoutAddAccountActivity.this, jsonObject.getString("message"), Toast.LENGTH_LONG, R.style.myToastSuccess).show();
                            }
                            startActivity(new Intent(FinoPayoutAddAccountActivity.this, FinoPayOutActivity.class));
                            finish();
                        } else {
                            StyleableToast.makeText(FinoPayoutAddAccountActivity.this, "Account Failed to Add!", Toast.LENGTH_LONG, R.style.myToastError).show();
                        }
                    } catch (JSONException e) {
                        throw new RuntimeException(e);
                    }
                ...
                public void onResponse(@NonNull Call<Object> call, @NonNull Response<Object> response) {
                    ...
                    try {
                        ...
                        if (jsonObject.has("status") && jsonObject.getBoolean("status")) {
                            ...
                            StyleableToast.makeText(FinoPayoutAddAccountActivity.this, "Upload Failed!", Toast.LENGTH_LONG, R.style.myToastError).show();
                        }
                    } catch (JSONException e) {
                        throw new RuntimeException(e);
                    }
        ...
        switch (requestCode) {
            case 100:
                if (resultCode == Activity.RESULT_OK) {
                    ...
                    StyleableToast.makeText(FinoPayoutAddAccountActivity.this, ImagePicker.getError(data), Toast.LENGTH_LONG, R.style.myToastError).show();
                } else {
                    StyleableToast.makeText(FinoPayoutAddAccountActivity.this, "Task Cancelled", Toast.LENGTH_LONG, R.style.myToastWarning).show();
                }
                break;
            case 101:
                if (resultCode == Activity.RESULT_OK) {
        ...
        objectCall.enqueue(new Callback<Object>() {
            ...
            public void onResponse(@NonNull Call<Object> call, @NonNull Response<Object> response) {
                ...
                try {
                    ...
                    ArrayAdapter<String> spinnerArrayAdapter = new ArrayAdapter<>(FinoPayoutAddAccountActivity.this, R.layout.layout_spinner_item, bankNameArrayList); //selected item will look like a spinner set from XML
