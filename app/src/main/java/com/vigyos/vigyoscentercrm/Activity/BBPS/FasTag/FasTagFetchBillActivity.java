...
public class FasTagFetchBillActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fas_tag_fetch_bill);
        Initialization();
        Declaration();
    }
    ...
    private void Declaration() {
        ...
        payBillButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                v.startAnimation(AnimationUtils.loadAnimation(FasTagFetchBillActivity.this, R.anim.viewpush));
                if (TextUtils.isEmpty(billNumber.getText().toString())) {
                    billNumber.setError("This field is required");
                    billNumber.requestFocus();
                    billNumberLyt.startAnimation(AnimationUtils.loadAnimation(FasTagFetchBillActivity.this, R.anim.shake_animation));
                    Toast.makeText(FasTagFetchBillActivity.this, "Enter " +displayname, Toast.LENGTH_SHORT).show();
                    return;
                }
                if (viewbill.equalsIgnoreCase("0")) {
                    if (TextUtils.isEmpty(billAmount.getText().toString())) {
                        ...
                        billAmountLyt.startAnimation(AnimationUtils.loadAnimation(FasTagFetchBillActivity.this, R.anim.shake_animation));
                        Toast.makeText(FasTagFetchBillActivity.this, "Enter Amount", Toast.LENGTH_SHORT).show();
                        return;
                    }
                    areYouSure(operatorId, billNumber.getText().toString(), billAmount.getText().toString());
                } else {
                    fetchBill(operatorId, billNumber.getText().toString(), name);
                }
            }
        });
    }
    ...
    private void areYouSure(String operatorId, String billNumber, String billAmount) {
        dialog = new Dialog(FasTagFetchBillActivity.this);
    ...
    private void payBillWithoutFetch(String operatorId, String billNumber, String billAmount) {
        ...
        requestModel.setTransactiontype("FASTAG_RECHARGE");
        ...
        Call<Object> call = RetrofitClient.getApi().fastTagPayBill(SplashActivity.prefManager.getToken(), jsonObject);
                ...
                try {
                    ...
                    if (jsonObject1.has("success") && jsonObject1.getBoolean("success")) {
                        if (jsonObject1.has("message")) {
                            DialogCustom.showAlertDialog(FasTagFetchBillActivity.this, "Payment Successful!", jsonObject1.getString("message"), "OKAY", false, () -> {
                                startActivity(new Intent(FasTagFetchBillActivity.this, MainActivity.class));
                                finish();
                            });
                        }
                    } else {
                        if (jsonObject1.has("message")) {
                            DialogCustom.showAlertDialog(FasTagFetchBillActivity.this, "Alert!", jsonObject1.getString("message"), "OK", true, () -> {});
                        }
                    }
    ...
    private void fetchBill(String OperatorId, String canumber, String OperatorName) {
        pleaseWait();
        Call<Object> objectCall = RetrofitClient.getApi().fastTagFetchBill(SplashActivity.prefManager.getToken(), OperatorId, canumber);
        objectCall.enqueue(new Callback<Object>() {
            ...
            public void onResponse(@NonNull Call<Object> call, @NonNull Response<Object> response) {
                ...
                dismissDialog();
                try {
                    Intent intent = new Intent(FasTagFetchBillActivity.this, FasTagPayBillActivity.class);
                    ...
                    if (jsonObject.has("success") && jsonObject.getBoolean("success")) {
                        ...
                        if (jsonObject.has("message")) {
                            DialogCustom.showAlertDialog(FasTagFetchBillActivity.this, "Alert!", jsonObject.getString("message"), "OK", true, () -> {});
                        }
                    }
                } catch (JSONException e) {
                    throw new RuntimeException(e);
            ...
            public void onFailure(@NonNull Call<Object> call, @NonNull Throwable t) {
                Log.i("2016", "onFailure " + t);
                dismissDialog();
                Toast.makeText(FasTagFetchBillActivity.this, "Maintenance underway. We'll be back soon.", Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    private boolean checkPermission() {
        int result = ContextCompat.checkSelfPermission(FasTagFetchBillActivity.this, ACCESS_FINE_LOCATION);
        return result == PackageManager.PERMISSION_GRANTED;
    }

    private void requestPermissions() {
        Dexter.withContext(FasTagFetchBillActivity.this)
    ...
    private void showSettingsDialog() {
        AlertDialog.Builder builder = new AlertDialog.Builder(FasTagFetchBillActivity.this);
    ...
    private void getLocation() {
        if (ContextCompat.checkSelfPermission(FasTagFetchBillActivity.this, Manifest.permission.ACCESS_FINE_LOCATION) == PackageManager.PERMISSION_GRANTED) {
            fusedLocationClient.getLastLocation()
                    .addOnSuccessListener(FasTagFetchBillActivity.this, new OnSuccessListener<Location>() {
                        @Override
                    ...
                    .addOnFailureListener(FasTagFetchBillActivity.this, new OnFailureListener() {
                        @Override
