...
public class FasTagPayBillActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fas_tag_pay_bill);
        Initialization();
        Declaration();
    }
    ...
    private void Declaration() {
        ...
        payBillButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                v.startAnimation(AnimationUtils.loadAnimation(FasTagPayBillActivity.this, R.anim.viewpush));
    ...
    private void areYouSure(String OperatorId, String billNumber, String amount){
        dialog1 = new Dialog(FasTagPayBillActivity.this);
                ...
                try {
                    ...
                    if (jsonObject1.has("success") && jsonObject1.getBoolean("success")) {
                        if (jsonObject1.has("message")) {
                            DialogCustom.showAlertDialog(FasTagPayBillActivity.this, "Payment Successful!", jsonObject1.getString("message"), "OKAY", false, () -> {
                                startActivity(new Intent(FasTagPayBillActivity.this, MainActivity.class));
                                finish();
                            });
                        }
                    } else {
                        if (jsonObject1.has("message")) {
                            DialogCustom.showAlertDialog(FasTagPayBillActivity.this, "Alert!", jsonObject1.getString("message"), "OK", true, () -> {});
                        }
                    }
    ...
    private boolean checkPermission() {
        int result = ContextCompat.checkSelfPermission(FasTagPayBillActivity.this, ACCESS_FINE_LOCATION);
        return result == PackageManager.PERMISSION_GRANTED;
    }

    private void requestPermissions() {
        Dexter.withContext(FasTagPayBillActivity.this)
    ...
    private void showSettingsDialog() {
        AlertDialog.Builder builder = new AlertDialog.Builder(FasTagPayBillActivity.this);
    ...
    private void getLocation() {
        if (ContextCompat.checkSelfPermission(FasTagPayBillActivity.this, Manifest.permission.ACCESS_FINE_LOCATION) == PackageManager.PERMISSION_GRANTED) {
            fusedLocationClient.getLastLocation()
                    .addOnSuccessListener(FasTagPayBillActivity.this, new OnSuccessListener<Location>() {
                        @Override
                    ...
                    .addOnFailureListener(FasTagPayBillActivity.this, new OnFailureListener() {
                        @Override
